...
export const pinDetailQuery = (pinId: IPinModel['_id']) => {
...
export const pinDetailMorePinQuery = (pin: IPinModel) => {
...
export const userCreatedPinsQuery = (userId: IUserModel['_id']) => {
...
export const userSavedPinsQuery = (userId: IUserModel['_id']) => {
